...
I have described how to download and read two high-dimensional datasets, one for regression and one for classification. Feel free to use them if you want. I have also pasted some other sources for finding interesting data-sets below where you can find more such data-sets. 
