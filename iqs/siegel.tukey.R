...
## The if(F){ 'examples' } trick is to put examples inside a code without running them 
## if you call this code from a different R console or code. 
...
(Z_score = (U-clt.mu)/(sqrt(clt.s2))) # Continuity correction, minus 1/2
