...
This report was based on the child death data from Pulaski county between 2012-2015. This report shows the locations and a fitted spatial density map for the deaths reported in this time period and the descriptive statistics for the categorical predictors given in the dataset. 
...
The following two plots show the counts per year and per week-year for the data-set. Note that there 
...
These were generated using the R package `summarytools`. Please note that the tables report the proportion and count in each category for the 10 categorical predictors provided in the data-set. I have not yet measured any association or dependence structure in this data. 
