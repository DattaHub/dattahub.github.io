...
## NEXT: Maltreatment risk and child fatalities

Figure 2.4(?) maps locations of child fatalities over the predicted maltreatment risk categories. The associated bar plot shows the majority of child fatalities are occurring in the highest risk categories.
