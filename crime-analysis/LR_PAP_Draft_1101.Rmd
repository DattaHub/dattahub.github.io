...
**Figure 2.7 plots the relative measure of risk exposure for quarter mile buffers around child youth centers.**


```{r include = TRUE, fig.width=10.5}
load("other_protective_facilities_plot_1201.RData")
childyouthMap
```
...
**Figure 2.8 plots the relative measure of risk exposure for quarter mile buffers around civil social organizations.**
