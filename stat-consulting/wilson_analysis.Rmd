...
author: "Jyotishka Datta <br> University of Arkansas"
date: "March 28, 2019"
output: 
  html_document:
      toc: true
...
```{r, echo = F, fig.height = 3.5, fig.cap= "Correlation Chart"}
...
```{r, echo = FALSE, fig.height = 3, fig.cap = "Association measures: chi-square and Cramer's V. Part 1"}
library(lsr)
...
```{r, echo = FALSE, fig.height = 3, fig.cap = "Association measures: chi-square and Cramer's V. Part 2"}
...
```{r, echo = F, fig.height = 3, fig.cap = "Boxplots for subgroup analysis: Age & Ceruloplasmin"}
...
```{r, echo = F, fig.height = 3, fig.cap = "Boxplots for subgroup analysis: MMSE" }
par(mfrow = c(1,2))
