...
The box plots show the distribution of the normalized scores between the two groups and it seems there is a significant difference between the scores. 

```{r, fig.asp = 0.6}
p1 <- ggplot(heart.wide, aes(Group, maintenance))
p1 + geom_boxplot() + geom_point() + labs(title = "Maintenance")
