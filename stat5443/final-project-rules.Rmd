...
### Final Projects (Part 1 : Implementation and Analysis)
...
1.  Part 1 is a group project - students will form groups of 3 and submit to me (jd033@uark.edu) by the end of March 3/31/2019. 
2.  Each team will be assigned one problem and a set of methods to compare. 
3.  Ideally you'd choose a different data-set than the ones shown in class or labs and choose 4 different methods to compare. 
4.  Your reports will be due by the final day of the class.  
