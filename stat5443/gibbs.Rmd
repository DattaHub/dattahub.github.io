...
nmc = 1000
burn = 1000
gibbs.fit <- normal_gibbs(y,niter = nmc+burn, mu0 = 2, sigma0 = 1)
...
plot(normal_gibbs(y,niter = 100, mu0 = 5, sigma0 = 1)$mu, type= "l", col = "red", 
     main = "Trace", ylim = c(-2.5,5.5), ylab = "MC")
lines(normal_gibbs(y,niter = 100, mu0 = -1, sigma0 = 1)$mu,col = "blue")
```
...
$$
-  Determining the burn-in $M$ is a critical part of MCMC diagnostics. 
...
## Diagnostics 1 - Trace plot {.build}
