---
title: "Nonparametric <br> Density Estimation <br> An Introduction"
...
-  $k$-NN: given a positive integer $k$, and a new, yet-unforeseen observation $x_0$, the KNN classifier first identifies the $k$ points in the training data that are
closest to $x_0$, represented by $N_0$.
...
-  Finally, $k$-NN classifies the test observation $x_0$
to the class with the largest probability.


## KNN 

<img src="knn.png"  height="600" width="900">
...
-  In K-nearest neighbour, you fix the number of neighbours (K)
centered on x, and let the region grow to a volume $V^*$. 

- The region $V^*$ will contain k out of n data points, and we can get:
$$
p(x) \approx \frac{k}{nV^*}
$$

In histogram of KDE, h acts as smoothing parameter, in k-NN, k
