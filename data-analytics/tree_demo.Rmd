...
<a href="javascript:slidedeck.loadSlide(3)">Decision Trees</a>

<a href="javascript:slidedeck.loadSlide(25)">Compare to logistic</a>

<a href="javascript:slidedeck.loadSlide(31)">Tree-based Regression</a>

<a href="javascript:slidedeck.loadSlide(39)">Bagging and Random Forest</a>
...
The test set MSE is 11.88: this indicates that random forests yielded a little
...
-  Sample $p$ predictors $X_1, X_2, \ldots, X_p$ from a known distribution (normal or uniform), consider 
$$
Y_i = f(\prod_{j=1}^{p} X_{i,j}) + \epsilon_i, \; i = 1, \ldots, n.
$$
