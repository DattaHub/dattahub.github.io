...
- We have seen 'loop's last time: for, while and repeat. Let's quickly recall their syntax. 
...
- The method here is 'Bootstrap': a resampling strategy for estimating sampling distribution of various statistics. 

- The idea is that you repeatedly *sample with replacement* from the given sample to get an idea about the underlying population distribution, which is an unknown quantity! 

- We will cover 'Bootstrap' in this class, later. 
